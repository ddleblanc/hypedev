  ...
  try {
    ...
    const dataToSave: DeploymentData = {
      ...
      collection: {
        ...
        maxSupply: collectionData.maxSupply ? parseInt(collectionData.maxSupply) : null,
        royaltyPercentage: parseFloat(collectionData.royaltyPercentage),
        chainId: parseInt(collectionData.chainId),
