            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <Button size="sm" variant="outline" className="flex-1 border-white/20 text-white hover:bg-white/10" onClick={() => onViewCollection ? onViewCollection(collection) : router.push(`/studio/collections/${collection.id}`)}>
