...
interface OfferSelectionMenuProps {
  onEditTraderNFTs: () => void;
  onChangeTrader: () => void;
  onCancel: () => void;
}

export function OfferSelectionMenu({
  onEditTraderNFTs,
  onChangeTrader,
  onCancel,
}: OfferSelectionMenuProps) {
          ...
          <>
            ...
            >
              ...
              <div className="px-5 pb-4 border-b border-white/10">
                <h3 className="text-xl font-bold text-white">Adjust Selection</h3>
                <p className="text-sm text-white/60 mt-1">
                  Edit trader's NFTs or change your trade partner
                </p>
              </div>
