    ...
    <TabsContent value="overview" className="mt-0 space-y-8">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
        <StatCard
          ...
          change={collection.stats.volumeChange24h}
          icon={Coins}
        />
        <StatCard
          title="24h Volume"
          value={`${collection.stats.volume24h} ETH`}
          change={collection.stats.volumeChange24h}
          icon={Activity}
        />
        <StatCard
          title="7d Volume"
          value={`${collection.stats.volume7d} ETH`}
          change={collection.stats.volumeChange7d}
          icon={TrendingUp}
        />
        <StatCard
          title="Market Cap"
          value={`${collection.stats.marketCap} ETH`}
          icon={DollarSign}
        />
        <StatCard
          title="Listed"
          value={collection.stats.listedCount.toLocaleString()}
          change={collection.stats.listedPercentage}
          icon={ShoppingCart}
        />
        <StatCard
          title="Unique Owners"
          value={collection.stats.uniqueOwners.toLocaleString()}
          icon={Users}
        />
      </div>
